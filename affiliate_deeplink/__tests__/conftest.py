...
@pytest.fixture(
    scope="function", params=[("https://www.carrefour.com.br/", "http://yahoo!!!!")]
)
...
@pytest.fixture(
    scope="function", params=[("https://boticario.com.br", "http://yahoo!!!!")]
)
...
@pytest.fixture(
    ...
    params=[
        (
            ...
            "https://www.awin1.com/cread.php?awinmid=17806&awinaffid=ALIEN&ued=https%3A%2F%2Fwww.centauro.com.br",
        ),
        (
            "https://www.wine.com.br/vinhos/red-rosso-rouge-vermelho-encarnado-rojo/prod23138.html",
            "https://www.awin1.com/cread.php?awinmid=17770&awinaffid=ALIEN&ued=https%3A%2F%2Fwww.wine.com.br%2Fvinhos%2Fred-rosso-rouge-vermelho-encarnado-rojo%2Fprod23138.html",
        ),
    ],
)
def awin_url(request):
    return request.param
